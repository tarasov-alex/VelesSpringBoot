...
public class StoreController {
    ...
    @PostMapping("/add")
    public ResponseEntity addAll(@RequestBody Iterable<Store> obs, @RequestHeader("token") String token, @RequestHeader("idOrganisation") String idOrganisation) {
        try {
    ...
    public ResponseEntity giveAllOfOrganisation(@RequestHeader("token") String token, @RequestHeader("idOrganisation") String idOrganisation) {
        try {
            ...
            String comma = "";
            for (Store store: storeService.giveAllOfOrganisation(idOrganisation)){
                text.append(comma)
                        .append(" ('")
